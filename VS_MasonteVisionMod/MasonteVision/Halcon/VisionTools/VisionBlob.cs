...
namespace HalconVision.VisionTool
{
    ...
    public class VisionBlob : IVisionTool
    {
        ...
        #endregion
        public ROIController ROIFindCtrl;// = new ROIController();
        public VisionBlob()
        {
            if (ROIFindCtrl == null)
            {
        ...
        {
            VisionBlobSetting f = new VisionBlobSetting(this);
            f.ShowDialog();
        }
        ...
        {
            HObject rectangleROI,/* ho_ImageInvert,*/ ho_Regions, ho_ConnectedRegions, ho_SelectedAreaRegions, ho_SelectedCirRegions, ho_Contours, ho_cross;
            HTuple hv_BlobCount;
            ResetResult();
            m_hWindow_Vision.mView.RemoveIconicVar();
            ...
            m_hWindow_Vision.mView.addIconicVar(ho_Contours.Clone());
            ...
            if (_BlobCount > 0)
            {
                ...
                m_hWindow_Vision.mView.addIconicVar(ho_cross.Clone());
        ...
        internal bool RunThreshold()
        {
            HObject rectangleROI,/* ho_ImageInvert,*/ ho_Regions, ho_ConnectedRegions, regionFillUp;
            ResetResult();
            hWindow.mView.RemoveIconicVar();
            ...
            {
                hWindow.mView.addIconicVar(InPutImage);
            }
            if (ROIFindCtrl.GetRegion() != null)
                HOperatorSet.ReduceDomain(InPutImage, ROIFindCtrl.GetRegion(), out rectangleROI);
            else
                rectangleROI = InPutImage;

            HOperatorSet.SetDraw(hWindow.ViewHwindow, "fill");
            ...
            hWindow.mView.addIconicVar(regionFillUp.Clone(), "red");
            ho_Regions.Dispose();
            ho_ConnectedRegions.Dispose();
            regionClosing.Dispose();
            regionFillUp.Dispose();
