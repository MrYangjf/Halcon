...
{
    [Serializable]
    public class CreatAffineModel
    {
        public ROI ROIFindCtrl;
        public ROI ROICreatCtrl;
        ...
        public CreatAffineModel(ROI MyRoi)
        {
            if (ROICreatCtrl == null)
                ROICreatCtrl = MyRoi;
            if (ROIFindCtrl == null)
                ROIFindCtrl = MyRoi;
        }
        public CreatAffineModel()
        {
        ...
        public HObject RunAffineFllowROI(HRegion InputRegion, HaGUI m_hWindow_Vision)
        {
        ...
        public bool RunVision(HObject hImage, HaGUI m_hWindow_Vision, ROI FindRoi)
        {
            if (FindRoi == null) FindRoi = ROICreatCtrl;
            ROIFindCtrl = FindRoi;
            ...
            HRegion CreatRegion = ROICreatCtrl.getRegion();
            ...
            try
            {
                ...
                if (_TemplateCount > 0)
                {
                    ...
                    SmartRay3DToolSave.hv_HomMat2DIdentity = hv_HomMat2DIdentity;
                    _CenterRow = hv_Row[0];
        ...
        public bool CreateShapeModel(HObject hImage, HaGUI m_hWindow_Vision)
        {
            ...
            try
            {
                CreatRegion = ROICreatCtrl.getRegion();
                ...
                if (Length1 != 0)
                {
                    ...
                    HOperatorSet.SetColor(m_hWindow_Vision.MyWindow, "blue");
                    HOperatorSet.DispObj(cross, m_hWindow_Vision.MyWindow);
                    m_hWindow_Vision.MyHWndControl.addIconicVar(ho_ModelContoursTrans);
                    m_hWindow_Vision.MyHWndControl.addIconicVar(cross);
                    _CenterRow = hv_Row;
